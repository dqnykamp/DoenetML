...
export default class Slider extends BaseComponent {
    ...
    static createAttributesObject() {
        ...
        attributes.showControls = {
            description: "Whether to render play/pause controls alongside the slider.",
        ...
        attributes.showValue = {
            description: "Whether to display the current value next to the slider.",
            createComponentOfType: "boolean",
    ...
    static returnStateVariableDefinitions() {
        ...
        stateVariableDefinitions.lastItem = {
            ...
            definition({ dependencyValues }) {
                ...
                if (dependencyValues.items.length > 0) {
                    lastItem =
                        dependencyValues.items[
                            dependencyValues.items.length - 1
                        ];
                } else if (dependencyValues.type === "number") {
                    lastItem =
                        ...
                        instructions: [
                            {
                                ...
                                desiredValue:
                                    desiredStateVariableValues.preliminaryValue,
                                variableIndex: 0,
                            },
                        ],
                    };
            ...
            definition: function ({ dependencyValues }) {
                ...
                if (dependencyValues.markersChild.length > 0) {
                    ...
                    if (markerType === "empty") {
                        ...
                        markers =
                            dependencyValues.markersChild[0].stateValues
                                .markers;
                    }
                }
