...
export default class Curve extends GraphicalComponent {
    ...
    static createAttributesObject() {
        ...
        attributes.flipFunction = {
            description: "Whether to swap the function and its argument (i.e., reflect across y=x).",
            createComponentOfType: "boolean",
        ...
        attributes.numDiscretizationPoints = {
            description: "Number of points used when discretizing the curve for rendering.",
        ...
        attributes.periodic = {
            description: "Whether the curve is treated as periodic when interpolating between control points.",
            createComponentOfType: "boolean",
        ...
        attributes.splineTension = {
            description: "Tension parameter used when fitting a spline through control points.",
            createComponentOfType: "number",
        ...
        attributes.extrapolateBackward = {
            description: "Whether to extrapolate the curve before its first defined point.",
            createComponentOfType: "boolean",
        ...
        attributes.extrapolateForward = {
            description: "Whether to extrapolate the curve beyond its last defined point.",
            createComponentOfType: "boolean",
        ...
        attributes.splineForm = {
            description: "Form of spline used to interpolate between control points.",
            createComponentOfType: "text",
        ...
        attributes.showCoordsWhenDragging = {
            description: "Whether to show coordinate labels while dragging the curve.",
            createComponentOfType: "boolean",
    ...
    static returnStateVariableDefinitions(numerics) {
        ...
        stateVariableDefinitions.fromVectorValuedFunctionOfDim = {
            ...
            definition({ dependencyValues }) {
                ...
                if (
                    ...
                    dependencyValues.functionChildren[0].stateValues
                        .numOutputs > 1
                ) {
                    ...
                    fromVectorValuedFunctionOfDim =
                        dependencyValues.fShadow.length;
                }
        ...
        stateVariableDefinitions.throughPoints = {
            ...
            arrayVarNameFromPropIndex(propIndex, varName) {
                ...
                if (varName.slice(0, 12) === "throughPoint") {
                    ...
                    if (
                        Number.isInteger(throughPointNum) &&
                        throughPointNum > 0
                    ) {
                        // if propIndex has additional entries, ignore them
            ...
            async inverseArrayDefinitionByKey({
                ...
                for (let arrayKey in desiredStateVariableValues.throughPoints) {
                    ...
                    if (
                        ...
                        instructions.push({
                            setDependency:
                                dependencyNamesByKey[arrayKey].through,
                            desiredValue:
                                desiredStateVariableValues.throughPoints[
                                    arrayKey
                                ],
                            childIndex: 0,
                            variableIndex: 0,
                ...
                for (let arrayKey of arrayKeys) {
                    dependenciesByKey[arrayKey] = {
                        throughPoint: {
                            dependencyType: "stateVariable",
                            variableName:
                                "throughPoint" + (Number(arrayKey) + 1),
                        },
                    };
                }
                ...
                return {
                    setValue: {
                        bezierControlsAlwaysVisible:
                            dependencyValues.controlChild.length > 0 &&
                            dependencyValues.controlChild[0].stateValues
                                .alwaysVisible,
                    },
                };
            },
        ...
        stateVariableDefinitions.vectorControlDirections = {
            ...
            arrayDefinitionByKey({ dependencyValuesByKey, arrayKeys }) {
                ...
                for (let arrayKey of arrayKeys) {
                    let controlChild =
                        dependencyValuesByKey[arrayKey].controlChild;
                    ...
                    if (controlChild && controlChild.length > 0) {
                        instructions.push({
                            setDependency:
                                dependencyNamesByKey[arrayKey].controlChild,
                            desiredValue:
                                desiredStateVariableValues.hiddenControls[
                                    arrayKey
                                ],
                            childIndex: 0,
                            variableIndex: 0,
                ...
                for (let arrayKey of arrayKeys) {
                    ...
                    dependenciesByKey[arrayKey] = {
                        direction: {
                            dependencyType: "stateVariable",
                            variableName:
                                "vectorControlDirection" + varEndings[0],
                        },
                        controlChild: {
                            dependencyType: "child",
                            childGroups: ["bezierControls"],
                    ...
                    let direction =
                        stateValues.vectorControlDirections[pointInd];
                    let indsToCheck = [];
                    if (direction === "none") {
                ...
                for (let arrayKey of arrayKeys) {
                    ...
                    if (direction === "none") {
                        ...
                        if (pointInd > 0) {
                            point1 =
                                dependencyValuesByKey[arrayKey][
                                    "throughPoint" + pointInd
                                ];
                        }
                        if (
                            pointInd < globalDependencyValues.numThroughPoints
                        ) {
                            point3 =
                                dependencyValuesByKey[arrayKey][
                        ...
                        if (control) {
                            instructions.push({
                                setDependency:
                                    dependencyNamesByKey[arrayKey].controlChild,
                                desiredValue:
                                    desiredStateVariableValues.controlVectors[
                                        arrayKey
                                    ],
                                childIndex: 0,
                                variableIndex: 0,
        ...
        stateVariableDefinitions.numericalControlVectors = {
            ...
            arrayDefinitionByKey({ dependencyValuesByKey, arrayKeys }) {
                ...
                for (let arrayKey of arrayKeys) {
                    let vect = dependencyValuesByKey[
                        arrayKey
                    ].controlVector.map((x) => x.tree);
        ...
        stateVariableDefinitions.controlPoints = {
            isArray: true,
            public: true,
            description: "The Bezier control points (vertex + offset) for each through-point.",
            isLocation: true,
            shadowingInstructions: {
                createComponentOfType: "math",
                addAttributeComponentsShadowingStateVariables:
            ...
            inverseArrayDefinitionByKey({
                ...
                for (let arrayKey in desiredStateVariableValues.controlPoints) {
                    ...
                    if (vectorX) {
                        ...
                        instructions.push({
                            setDependency:
                                dependencyNamesByKey[arrayKey].controlVectorX,
                            desiredValue,
                        });
                    }
                }
                ...
                for (let arrayKey of arrayKeys) {
                    ...
                    dependenciesByKey[arrayKey] = {
                        ...
                        previousVector: {
                            dependencyType: "stateVariable",
                            variableName:
                                "numericalControlVector" + ind1 + "_2",
                        },
                        nextVector: {
                            dependencyType: "stateVariable",
                            variableName:
                                "numericalControlVector" + ind2 + "_1",
                        },
                    };
                }
            ...
            additionalStateVariablesDefined: [
                {
                    ...
                    public: true,
            description: "Coefficients used when extrapolating before the first through-point.",
                    shadowingInstructions: {
                        createComponentOfType: "text",
                    },
                },
            ...
            definition({ dependencyValues }) {
                ...
                if (
                    ...
                    if (
                        ...
                        let xscale =
                            dependencyValues.graphXmax -
                            dependencyValues.graphXmin;
                        let yscale =
                            dependencyValues.graphYmax -
                            dependencyValues.graphYmin;
                        let tMax = dependencyValues.numThroughPoints - 1;

                        let scaleSpeedToReachXEdge =
                            xscale / tMax / Math.abs(xpEffective);
                        let scaleSpeedToReachYEdge =
                            yscale / tMax / Math.abs(ypEffective);
            ...
            additionalStateVariablesDefined: [
                {
                    ...
                    public: true,
            description: "Coefficients used when extrapolating beyond the last through-point.",
                    shadowingInstructions: {
                        createComponentOfType: "text",
                    },
                },
            ...
            returnDependencies({ stateValues }) {
                ...
                if (
                    ...
                    dependencies.lastSplineCoeffs = {
                        dependencyType: "stateVariable",
                        variableName:
                            "splineCoeffs" + (stateValues.numThroughPoints - 1),
                    };
                    dependencies.graphXmin = {
                        dependencyType: "stateVariable",
                        variableName: "graphXmin",
        ...
        stateVariableDefinitions.fs = {
            ...
            public: true,
            description: "The component functions of the curve as functions of its parameter.",
            shadowingInstructions: {
            ...
            arrayDefinitionByKey({
                ...
                for (let arrayKey of arrayKeys) {
                    let functionChild =
                        dependencyValuesByKey[arrayKey].functionChild;
                    if (functionChild.length === 1) {
                        if (
                            globalDependencyValues.fromVectorValuedFunctionOfDim >
                            1
                        ) {
                            let dim = Number(arrayKey) + 1;
                            fs[arrayKey] =
                                functionChild[0].stateValues[
                                    `numericalf${dim}`
                                ];
                            ...
                            fs[arrayKey] =
                                functionChild[0].stateValues.numericalf;
                            fDefinitions[arrayKey] =
                                functionChild[0].stateValues.fDefinition;
                        }
                    } else {
                        if (
                            globalDependencyValues.fromVectorValuedFunctionOfDim >
                            ...
                            fs[arrayKey] =
                                globalDependencyValues.fShadow[arrayKey];
                            fDefinitions[arrayKey] =
                                globalDependencyValues.fDefinitionsAdapted[
                                    arrayKey
                                ];
                        } else {
                            if (
        ...
        stateVariableDefinitions.numXCriticalPoints = {
            description: "The number of x-critical points (horizontal tangents) on the curve.",
            public: true,
            shadowingInstructions: {
            ...
            definition({ dependencyValues }) {
                return {
                    setValue: {
                        numXCriticalPoints:
                            dependencyValues.allXCriticalPoints.length,
                    },
                };
            },
        };
        ...
        stateVariableDefinitions.xCriticalPoints = {
            description: "The x-critical points (horizontal tangents) on the curve.",
            public: true,
            shadowingInstructions: {
                createComponentOfType: "number",
                addAttributeComponentsShadowingStateVariables:
            ...
            arrayVarNameFromPropIndex(propIndex, varName) {
                ...
                if (varName.slice(0, 14) === "xCriticalPoint") {
                    ...
                    if (
                        Number.isInteger(xCriticalPointNum) &&
                        xCriticalPointNum > 0
                    ) {
                        // if propIndex has additional entries, ignore them
        ...
        stateVariableDefinitions.numYCriticalPoints = {
            description: "The number of y-critical points (vertical tangents) on the curve.",
            public: true,
            shadowingInstructions: {
                createComponentOfType: "integer",
            },
            ...
            definition({ dependencyValues }) {
                return {
                    setValue: {
                        numYCriticalPoints:
                            dependencyValues.allYCriticalPoints.length,
                    },
                };
            },
        };
        ...
        stateVariableDefinitions.yCriticalPoints = {
            description: "The y-critical points (vertical tangents) on the curve.",
            public: true,
            shadowingInstructions: {
                createComponentOfType: "number",
                addAttributeComponentsShadowingStateVariables:
            ...
            arrayVarNameFromPropIndex(propIndex, varName) {
                ...
                if (varName.slice(0, 14) === "yCriticalPoint") {
                    ...
                    if (
                        Number.isInteger(yCriticalPointNum) &&
                        yCriticalPointNum > 0
                    ) {
                        // if propIndex has additional entries, ignore them
        ...
        stateVariableDefinitions.numCurvatureChangePoints = {
            description: "The number of points where the curve's curvature changes sign.",
            public: true,
            shadowingInstructions: {
                createComponentOfType: "integer",
            },
        ...
        stateVariableDefinitions.curvatureChangePoints = {
            description: "Points where the curve's curvature changes sign (inflection points).",
            public: true,
            shadowingInstructions: {
                createComponentOfType: "number",
                addAttributeComponentsShadowingStateVariables:
                ...
                for (
                    ...
                    for (let i = 0; i < 2; i++) {
                        ...
                        curvatureChangePoints[arrayKey] =
                            globalDependencyValues.allCurvatureChangePoints[
                                ptInd
                            ][i];
                    }
                }
        ...
        stateVariableDefinitions.nearestPointAsCurve = {
            ...
            definition({ dependencyValues, usedDefault }) {
                let nearestPointAsCurve =
                    dependencyValues.nearestPointAsCurvePrelim;
                if (usedDefault.nearestPointAsCurvePrelim) {
                    if (dependencyValues.functionChild.length > 0) {
                        ...
                        nearestPointAsCurve =
                            dependencyValues.adapterSourceValue;
                    }
                }
                ...
                updateInstructions: [
                    {
                        ...
                        value: desiredVector,
                        sourceDetails: {
                            controlVectorMoved: controlVectorInds,
                        },
                    },
                ],
                transient,
