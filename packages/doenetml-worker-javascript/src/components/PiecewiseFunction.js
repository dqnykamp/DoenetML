        ...
        stateVariableDefinitions.domain = {
            ...
            definition({ dependencyValues }) {
                if (dependencyValues.domainAttr !== null) {
                    let domain =
                        dependencyValues.domainAttr.stateValues.intervals[0];
        ...
        stateVariableDefinitions.numericalfs = {
            ...
            arrayDefinitionByKey: function ({
                ...
                if (globalDependencyValues.functionChildren.length > 0) {
                    let numericalfs = {};
                    for (let arrayKey of arrayKeys) {
                        let numericalFsOfChildren =
                            globalDependencyValues.functionChildren
                                .filter(
                                    (_, i) =>
                                        globalDependencyValues
            ...
            definition: function ({ dependencyValues }) {
                ...
                for (let [
                    ...
                    if (dependencyValues.childrenWithNonNumericDomains[ind]) {
                        ...
                        if (
                            effectiveDomainsOfChildrenIgnoringDomain[
                                ind
                            ].isEmpty()
                        ) {
                            continue;
                        ...
                        if (
                            ...
                            let indexOfFormula =
                                formulaLatexByLine.lastIndexOf(formulaLatex);
