...
export default class ConstrainToAngles extends ConstraintComponent {
    ...
    static componentDocs = {
        summary: "Constrains a graphical component's position to specified angles.",
    };
    ...
    static returnChildLogic(args) {
        ...
        let addAngles = function ({ activeChildrenMatched }) {
            ...
            return {
                success: true,
                newChildren: [
                    { componentType: "angles", children: anglesChildren },
                ],
            };
        };
    ...
    updateState(args = {}) {
        ...
        if (this.state.pointChild) {
            ...
            if (
                ...
                for (
                    let i = 0;
                    i < this.state.pointChild.state.ndimensions;
                    i++
                ) {
                    let temp =
                        this.state.pointChild.state.xs[
                            i
