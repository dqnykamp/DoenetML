...
export default class Function extends InlineComponent {
    ...
    static createAttributesObject() {
        ...
        attributes.layer = {
            description: "Z-order layer index for stacking the function on a graph.",
            createComponentOfType: "number",
    ...
    static returnStateVariableDefinitions(numerics) {
        ...
        stateVariableDefinitions.numInputs = {
            ...
            definition({ dependencyValues }) {
                if (dependencyValues.isInterpolatedFunction) {
                    ...
                    let numInputs =
                        dependencyValues.numInputsAttr.stateValues.value;
                    if (!(numInputs >= 0)) {
                        numInputs = 1;
                    }
        ...
        stateVariableDefinitions.numOutputs = {
            ...
            definition({ dependencyValues }) {
                if (dependencyValues.functionChild.length > 0) {
                    ...
                    let numOutputs =
                        dependencyValues.numOutputsAttr.stateValues.value;
                    if (!(numOutputs >= 0)) {
                        numOutputs = 1;
                    }
        ...
        stateVariableDefinitions.domain = {
            ...
            arrayDefinitionByKey({ globalDependencyValues }) {
                if (globalDependencyValues.domainAttr !== null) {
                    ...
                    return {
                        setValue: {
                            domain: globalDependencyValues.functionChild[0]
                                .stateValues.domain,
                        },
                    };
                } else {
        ...
        stateVariableDefinitions.simplify = {
            description: "Level of simplification applied when displaying the formula.",
            public: true,
            shadowingInstructions: {
                createComponentOfType: "text",
            },
            ...
            definition({ dependencyValues, usedDefault }) {
                if (
                    ...
                    return {
                        setValue: {
                            simplify: dependencyValues.simplifySpecified,
                        },
                    };
                }
            },
                        ...
                        instructions: [
                            {
                                ...
                                desiredValue:
                                    desiredStateVariableValues.simplify,
                                childIndex: 0,
                                variableIndex: 0,
                            },
                        ],
        ...
        stateVariableDefinitions.expand = {
            ...
            definition({ dependencyValues, usedDefault }) {
                if (
                    ...
                    return {
                        setValue: {
                            expand: dependencyValues.functionChild[0]
                                .stateValues.expand,
                        },
                    };
                } else {
                    return {
                        setValue: { expand: dependencyValues.expandSpecified },
                    };
                }
            },
            inverseDefinition({
            ...
            definition({ dependencyValues }) {
                if (dependencyValues.symbolicAttr !== null) {
                    return {
                        setValue: {
                            symbolic:
                                dependencyValues.symbolicAttr.stateValues.value,
                        },
                    };
                } else if (dependencyValues.functionChild.length > 0) {
                    return {
            ...
            arrayDefinitionByKey({
                ...
                if (
                    ...
                    let variablesSpecified =
                        globalDependencyValues.variablesAttr?.stateValues
                            .variables;
                    if (!variablesSpecified) {
                        variablesSpecified = [
                            globalDependencyValues.variableAttr.stateValues
                                .value,
                        ];
                    }
                    return {
        ...
        stateVariableDefinitions.haveNaNChildToReevaluate = {
            ...
            definition({ dependencyValues }) {
                ...
                if (dependencyValues.mathChildMathChildren?.length > 0) {
                    ...
                    dependencyValues.mathChild?.[0].stateValues.fReevaluate
                ) {
                    ...
                    let inputVariables =
                        mathChild.stateValues.inputMaths.reduce(
                            (a, c) => [
                                ...a,
                    ...
                    if (
                        ...
                        if (containsNaN(mathChild.stateValues.value.tree)) {
                            return {
                                setValue: { haveNaNChildToReevaluate: true },
                            };
                        }
                    }
                }
                ...
                if (dependencyValues.isInterpolatedFunction) {
                    ...
                    if (dependencyValues.haveNaNChildToReevaluate) {
                        ...
                        return {
                            setValue: {
                                formula:
                                    dependencyValues.mathChild[0].stateValues
                                        .value,
                            },
                        };
                    }
            ...
            arrayDefinitionByKey({ dependencyValuesByKey, arrayKeys }) {
                ...
                for (let arrayKey of arrayKeys) {
                    ...
                    if (through !== null) {
                        ...
                        let throughSlopes =
                            dependencyValuesByKey[arrayKey].throughSlopes;
                        if (throughSlopes !== null) {
                            slope =
                                throughSlopes.stateValues["math" + pointNum];
                            if (slope === undefined) {
                                slope = null;
                            }
                        }
        ...
        stateVariableDefinitions.prescribedMinima = {
            ...
            definition({ dependencyValues }) {
                ...
                if (dependencyValues.minima !== null) {
                    prescribedMinima =
                        dependencyValues.minima.stateValues.extrema.map(
                            (v) => ({
                                x: v[0],
                                y: v[1],
                            }),
        ...
        stateVariableDefinitions.prescribedMaxima = {
            ...
            definition({ dependencyValues }) {
                ...
                if (dependencyValues.maxima !== null) {
                    prescribedMaxima =
                        dependencyValues.maxima.stateValues.extrema.map(
                            (v) => ({
                                x: v[0],
                                y: v[1],
                            }),
        ...
        stateVariableDefinitions.prescribedExtrema = {
            ...
            definition({ dependencyValues }) {
                ...
                if (dependencyValues.extrema !== null) {
                    prescribedExtrema =
                        dependencyValues.extrema.stateValues.extrema.map(
                            (v) => ({
                                x: v[0],
                                y: v[1],
                            }),
            ...
            arrayDefinitionByKey: function ({
                ...
                if (globalDependencyValues.isInterpolatedFunction) {
                            ...
                            if (mathGrandChild.stateValues.fReevaluate) {
                                ...
                                if (
                                    ...
                                    subsMapping[codePre + ind] =
                                        mathGrandChild.stateValues.value;
                                }
                            } else {
                                    ...
                                    returnSymbolicFunctionFromReevaluatedFormula(
                                        {
                                            ...
                                            evaluateChildrenToReevaluate,
                                            simplify:
                                                globalDependencyValues.simplify,
                    ...
                    for (let arrayKey of arrayKeys) {
                        if (arrayKey === "0") {
                            symbolicfs[arrayKey] =
                                globalDependencyValues.symbolicfShadow;
                        } else {
                            symbolicfs[arrayKey] = (x) => me.fromAst("\uff3f");
                        }
                    }
        ...
        stateVariableDefinitions.numericalf = {
            ...
            definition({ dependencyValues }) {
                return {
                    setValue: { numericalf: dependencyValues.numericalf1 },
                };
            },
        };
                                ...
                                code: {
                                    fReevaluateDefinition:
                                        mathChild.stateValues
                                            .fReevaluateDefinition,
                                    inputMaths:
                                        mathChild.stateValues.inputMaths,
                                },
                            };
        ...
        stateVariableDefinitions.fs = {
            ...
            arrayDefinitionByKey({
                ...
                if (globalDependencyValues.symbolic) {
                    for (let arrayKey of arrayKeys) {
                        fs[arrayKey] =
                            dependencyValuesByKey[arrayKey].symbolicf;
                    }
                } else {
                    for (let arrayKey of arrayKeys) {
                        fs[arrayKey] =
                            dependencyValuesByKey[arrayKey].numericalf;
                    }
                }
                return { setValue: { fs } };
            },
        ...
        stateVariableDefinitions.latex = {
            ...
            definition: function ({ dependencyValues }) {
                if (
                    ...
                    return {
                        setValue: {
                            latex: dependencyValues.functionChild[0].stateValues
                                .latex,
                        },
                    };
                }
            ...
            definition: function ({ dependencyValues }) {
                let { localMinima, globalMinimum, globalInfimum } =
                    find_local_global_minima({
                        ...
                        isInterpolatedFunction:
                            dependencyValues.isInterpolatedFunction,
            ...
            arrayDefinitionByKey({ globalDependencyValues }) {
                ...
                for (
                    ...
                    for (let i = 0; i < 2; i++) {
                        ...
                        minima[arrayKey] =
                            globalDependencyValues.allMinima[ptInd][i];
                    }
                }
        ...
        stateVariableDefinitions.globalMinimum = {
            ...
            arrayDefinitionByKey({ globalDependencyValues }) {
                return {
                    setValue: {
                        globalMinimum:
                            globalDependencyValues.globalMinimumOption,
                    },
                };
            },
        };
        ...
        stateVariableDefinitions.globalInfimum = {
            ...
            arrayDefinitionByKey({ globalDependencyValues }) {
                return {
                    setValue: {
                        globalInfimum:
                            globalDependencyValues.globalInfimumOption,
                    },
                };
            },
        };
            ...
            arrayDefinitionByKey({ globalDependencyValues }) {
                ...
                for (
                    ...
                    for (let i = 0; i < 2; i++) {
                        ...
                        maxima[arrayKey] =
                            globalDependencyValues.allMaxima[ptInd][i];
                    }
                }
        ...
        stateVariableDefinitions.globalMaximum = {
            ...
            arrayDefinitionByKey({ globalDependencyValues }) {
                return {
                    setValue: {
                        globalMaximum:
                            globalDependencyValues.globalMaximumOption,
                    },
                };
            },
        };
        ...
        stateVariableDefinitions.globalSupremum = {
            ...
            arrayDefinitionByKey({ globalDependencyValues }) {
                return {
                    setValue: {
                        globalSupremum:
                            globalDependencyValues.globalSupremumOption,
                    },
                };
            },
        };
        ...
        stateVariableDefinitions.numExtrema = {
            description: "Number of local extrema (minima + maxima) of the function.",
            public: true,
            shadowingInstructions: {
                createComponentOfType: "number",
            },
            ...
            definition: function ({ dependencyValues }) {
                return {
                    setValue: {
                        numExtrema:
                            dependencyValues.numMinima +
                            dependencyValues.numMaxima,
                    },
                    ...
                    if (Number.isInteger(pointInd) && pointInd >= 0) {
                        ...
                        if (!arraySize || pointInd < arraySize[0]) {
                            if (arrayEntryPrefix === "extremum") {
                                ...
                                arrayEntryPrefix === "extremumLocation"
                            ) {
                                return [pointInd + ",0"];
                            } else {
                                return [pointInd + ",1"];
            ...
            arrayDefinitionByKey({ globalDependencyValues }) {
                ...
                for (
                    ...
                    for (let i = 0; i < 2; i++) {
                        ...
                        extrema[arrayKey] =
                            globalDependencyValues.allExtrema[ptInd][i];
                    }
                }
                    ...
                    if (
                        ...
                        if (Object.keys(variableMapping).length === 0) {
                            return {
                                setValue: {
                                    returnNumericalDerivatives:
                                        dependencyValues.functionChild[0]
                                            .stateValues
                                            .returnNumericalDerivatives,
                                },
                            };
                            ...
                            let returnNumericalDerivatives = function (
                                ...
                                for (let dVar of derivVariables) {
                                    let mapped =
                                        variableMapping[
                                            dVar.subscripts_to_strings().tree
                                        ];
                                    if (mapped) {
                        ...
                        return {
                            setValue: { returnNumericalDerivatives: null },
                        };
                    }
                }
            },
                ...
                if (dependencyValues.isInterpolatedFunction) {
                    ...
                    if (
                        ...
                        if (Object.keys(variableMapping).length === 0) {
                            ...
                            return {
                                setValue: {
                                    numericalDerivativesDefinition: derivDef,
                                },
                            };
                        }
                    } else {
                        return {
                            setValue: { numericalDerivativesDefinition: {} },
                        };
                    }
                }
            },
        ...
        if (interpolationPoints.length === 1) {
            ...
            if (prevPoint.type === "maximum" || prevPoint.type === "minimum") {
                ...
                if (interpolationPoints.length === 2) {
                    ...
                    if (lastPoint.slope === null) {
                        lastPoint.slope =
                            (2 * (prevPoint.y - lastPoint.y)) /
                                (prevPoint.x - lastPoint.x) -
                            prevPoint.slope;
                    }
                }
...
function computeSplineParamCoeffs({ dependencyValues }) {
    ...
    for (let ind = 1; ind < interpolationPoints.length; ind++) {
        ...
        if (
            ...
            if (
                Math.abs(c[2]) <
                1e-14 * Math.max(Math.abs(c[0]), Math.abs(c[1]))
            ) {
                c[2] = 0;
            }
        }
