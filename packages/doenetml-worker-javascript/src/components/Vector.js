    ...
    static returnStateVariableDefinitions() {
            ...
            definition({ dependencyValues }) {
                if (dependencyValues.tailDraggableAttr) {
                    return {
                        setValue: {
                            tailDraggable:
                                dependencyValues.tailDraggableAttr.stateValues
                                    .value,
                        },
                    };
                } else {
            ...
            definition({ dependencyValues }) {
                if (dependencyValues.headDraggableAttr) {
                    return {
                        setValue: {
                            headDraggable:
                                dependencyValues.headDraggableAttr.stateValues
                                    .value,
                        },
                    };
                } else {
        ...
        stateVariableDefinitions.basedOnHead = {
            ...
            definition: function ({ dependencyValues }) {
                ...
                return {
                    setValue: {
                        basedOnHead: dependencyValues.headShadow !== null,
                    },
                    checkForActualChange: { basedOnHead: true },
                };
            },
        ...
        stateVariableDefinitions.basedOnTail = {
            ...
            definition: function ({ dependencyValues }) {
                ...
                return {
                    setValue: {
                        basedOnTail: dependencyValues.tailShadow !== null,
                    },
                    checkForActualChange: { basedOnTail: true },
                };
            },
        ...
        stateVariableDefinitions.basedOnDisplacement = {
            ...
            definition: function ({ dependencyValues }) {
                ...
                return {
                    setValue: {
                        basedOnDisplacement:
                            dependencyValues.displacementShadow !== null,
                    },
                    checkForActualChange: { basedOnDisplacement: true },
                };
            },
            ...
            definition: function ({ dependencyValues }) {
                ...
                if (dependencyValues.basedOnDisplacement) {
                    switch (dependencyValues.sourceOfDisplacement) {
                        ...
                        case "xsAttr":
                            numDimDisplacement =
                                dependencyValues.xsAttr.stateValues
                                    .numComponents;
                            break;
                        case "componentAttrs":
                        ...
                        default:
                            ...
                            let displacementTree2 =
                                dependencyValues.displacementShadow
                                    .tuples_to_vectors()
                                    .expand()
                                    .simplify().tree;
                            if (
        ...
        stateVariableDefinitions.numDimHead = {
            ...
            definition: function ({ dependencyValues }) {
                ...
                if (dependencyValues.basedOnHead) {
                    if (dependencyValues.headAttr !== null) {
                        numDimHead =
                            dependencyValues.headAttr.stateValues.numDimensions;
        ...
        stateVariableDefinitions.numDimTail = {
            ...
            definition: function ({ dependencyValues }) {
                ...
                if (dependencyValues.basedOnTail) {
                    if (dependencyValues.tailAttr !== null) {
                        numDimTail =
                            dependencyValues.tailAttr.stateValues.numDimensions;
        ...
        stateVariableDefinitions.displacement = {
            ...
            returnArrayDependenciesByKey({ arrayKeys, stateValues }) {
                ...
                for (let arrayKey of arrayKeys) {
                    ...
                    if (
                        !stateValues.basedOnDisplacement &&
                        stateValues.basedOnHead
                    ) {
            ...
            arrayDefinitionByKey: function ({
                ...
                if (globalDependencyValues.basedOnDisplacement) {
                    if (
                        globalDependencyValues.sourceOfDisplacement ===
                        "displacementAttr"
                    ) {
                        prescribedDisplacement =
                            globalDependencyValues.displacementAttr.stateValues
                                .value;
                    } else if (
                        globalDependencyValues.sourceOfDisplacement === null
                    ) {
                        prescribedDisplacement =
                ...
                if (prescribedDisplacement) {
                    prescribedDisplacement = prescribedDisplacement
                        .expand()
                        .simplify();
                    ...
                    for (let arrayKey of arrayKeys) {
                        ...
                        if (globalDependencyValues.basedOnDisplacement) {
                            ...
                            displacement[arrayKey] = dependencyValuesByKey[
                                arrayKey
                            ].headX
                    ...
                    if (
                        ...
                        if (arraySize[0] > 1) {
                            ...
                            instructions.push({
                                setDependency: "displacementAttr",
                                desiredValue:
                                    desiredStateVariableValues.displacement[0],
                                variableIndex: 0,
                            });
                        }
                        return {
                    ...
                    if (globalDependencyValues.basedOnDisplacement) {
                        switch (globalDependencyValues.sourceOfDisplacement) {
                            ...
                            case "xsAttr":
                                instructions.push({
                                    setDependency:
                                        dependencyNamesByKey[arrayKey].xsAttr,
                                    desiredValue:
                                        desiredStateVariableValues.displacement[
                                            arrayKey
                                        ],
                    ...
                    if (globalDependencyValues.basedOnHead) {
                        if (dependencyValuesByKey[arrayKey].headAttr !== null) {
                            head[arrayKey] =
                                dependencyValuesByKey[
                                    arrayKey
                                ].headAttr.stateValues["x" + varEnding];
                ...
                for (let arrayKey in desiredStateVariableValues.head) {
                    if (globalDependencyValues.basedOnHead) {
                        if (
                            ...
                            instructions.push({
                                setDependency:
                                    dependencyNamesByKey[arrayKey].headAttr,
                                desiredValue:
                                    desiredStateVariableValues.head[arrayKey],
                                variableIndex: 0,
                            });
                        } else if (globalDependencyValues.headShadow !== null) {
                ...
                for (let arrayKey of arrayKeys) {
                    ...
                    if (dependencyValuesByKey[arrayKey].tailAttr !== null) {
                        tail[arrayKey] =
                            dependencyValuesByKey[
                                arrayKey
                            ].tailAttr.stateValues["x" + varEnding];
                        ...
                        if (
                            ...
                            tail[arrayKey] = dependencyValuesByKey[
                                arrayKey
                            ].headX
            ...
            inverseArrayDefinitionByKey({
                ...
                for (let arrayKey in desiredStateVariableValues.tail) {
                    if (
                        ...
                        instructions.push({
                            setDependency:
                                dependencyNamesByKey[arrayKey].tailAttr,
                            desiredValue:
                        ...
                        if (
                            ...
                            instructions.push({
                                setDependency: dependencyNamesByKey[arrayKey].x,
                                desiredValue: dependencyValuesByKey[
                                    arrayKey
                                ].headX
                                    .subtract(
        ...
        stateVariableDefinitions.magnitude = {
            ...
            definition({ dependencyValues }) {
                ...
                if (all_numeric) {
                    return {
                        setValue: {
                            magnitude: me.fromAst(Math.sqrt(magnitude2)),
                        },
                    };
                }
                ...
                for (let dim = 0; dim < dependencyValues.numDimensions; dim++) {
                    magnitude2.push([
                        "^",
                        dependencyValues.displacement[dim],
                        2,
                    ]);
                }
            ...
            inverseDefinition({
                ...
                if (
                    !Number.isFinite(desiredMagnitude) ||
                    desiredMagnitude < 0
                ) {
                    return { success: false };
                }
        ...
        stateVariableDefinitions.numericalEndpoints = {
            ...
            definition: function ({ dependencyValues }) {
                ...
                return {
                    setValue: {
                        numericalEndpoints: [numericalTail, numericalHead],
                    },
                };
            },
        };
        ...
        stateVariableDefinitions.displacementCoords = {
            ...
            definition({ dependencyValues }) {
                ...
                return {
                    setValue: { displacementCoords: me.fromAst(coordsAst) },
                };
            },
            inverseDefinition({ desiredStateVariableValues }) {
                let coordsAst =
                    desiredStateVariableValues.displacementCoords.tree;
                let newDisplacement;
                ...
                if (
                    ...
                    newDisplacement = coordsAst
                        .slice(1)
                        .map((x) => me.fromAst(x));
                } else {
                    newDisplacement = [
                        desiredStateVariableValues.displacementCoords,
                    ];
                }
