    ...
    static returnStateVariableDefinitions() {
        ...
        stateVariableDefinitions.basedOnThrough = {
            ...
            definition: function ({ dependencyValues }) {
                ...
                return {
                    setValue: {
                        basedOnThrough: dependencyValues.throughShadow !== null,
                    },
                    checkForActualChange: { basedOnThrough: true },
                };
            },
        ...
        stateVariableDefinitions.basedOnEndpoint = {
            ...
            definition: function ({ dependencyValues }) {
                ...
                return {
                    setValue: {
                        basedOnEndpoint:
                            dependencyValues.endpointShadow !== null,
                    },
                    checkForActualChange: { basedOnEndpoint: true },
                };
            },
        ...
        stateVariableDefinitions.basedOnDirection = {
            ...
            definition: function ({ dependencyValues }) {
                ...
                return {
                    setValue: {
                        basedOnDirection:
                            dependencyValues.directionShadow !== null,
                    },
                    checkForActualChange: { basedOnDirection: true },
                };
            },
        ...
        stateVariableDefinitions.numDimDirection = {
            ...
            definition: function ({ dependencyValues }) {
                ...
                if (dependencyValues.basedOnDirection) {
                    if (dependencyValues.directionAttr !== null) {
                        numDimDirection =
                            dependencyValues.directionAttr.stateValues
                                .numDimensions;
                    } else if (dependencyValues.directionShadow) {
                        let directionTree =
                            dependencyValues.directionShadow.tree;
                        if (
        ...
        stateVariableDefinitions.numDimEndpoint = {
            ...
            definition: function ({ dependencyValues }) {
                ...
                if (dependencyValues.basedOnEndpoint) {
                    if (dependencyValues.endpointAttr !== null) {
                        numDimEndpoint =
                            dependencyValues.endpointAttr.stateValues
                                .numDimensions;
        ...
        stateVariableDefinitions.direction = {
            ...
            returnArrayDependenciesByKey({ arrayKeys, stateValues }) {
                ...
                for (let arrayKey of arrayKeys) {
                    ...
                    if (
                        !stateValues.basedOnDirection &&
                        stateValues.basedOnThrough
                    ) {
            ...
            arrayDefinitionByKey: function ({
                ...
                for (let arrayKey of arrayKeys) {
                    ...
                    if (globalDependencyValues.basedOnDirection) {
                        if (
                            dependencyValuesByKey[arrayKey].directionAttr !==
                            null
                        ) {
                            direction[arrayKey] =
                                dependencyValuesByKey[
                                    arrayKey
                                ].directionAttr.stateValues["x" + varEnding];
                        } else if (
                            globalDependencyValues.directionShadow !== null
                        ) {
                            direction[arrayKey] =
                        ...
                        direction[arrayKey] = dependencyValuesByKey[
                            arrayKey
                        ].throughX
            ...
            inverseArrayDefinitionByKey({
                ...
                for (let arrayKey in desiredStateVariableValues.direction) {
                    if (globalDependencyValues.basedOnDirection) {
                        ...
                        instructions.push({
                            setDependency:
                                dependencyNamesByKey[arrayKey].throughX,
                ...
                if (updateDirectionShadow) {
                    if (arraySize[0] > 1) {
                        ...
                        instructions.push({
                            setDependency: "directionShadow",
                            desiredValue:
                                desiredStateVariableValues.direction[0],
                        });
                    }
                }
                    ...
                    if (globalDependencyValues.basedOnThrough) {
                        if (
                            ...
                            through[arrayKey] =
                                dependencyValuesByKey[
                                    arrayKey
                                ].throughAttr.stateValues["x" + varEnding];
                        } else if (
                            globalDependencyValues.throughShadow !== null
                        ) {
                            through[arrayKey] =
                        ...
                        through[arrayKey] = dependencyValuesByKey[
                            arrayKey
                        ].endpointX
                    ...
                    if (globalDependencyValues.basedOnThrough) {
                        if (
                            ...
                            instructions.push({
                                ...
                                desiredValue:
                                    desiredStateVariableValues.through[
                                        arrayKey
                                    ],
                                variableIndex: 0,
                            });
                        ...
                        instructions.push({
                            setDependency:
                                dependencyNamesByKey[arrayKey].directionX,
                            desiredValue: desiredStateVariableValues.through[
                                arrayKey
                            ]
                                .subtract(
                ...
                for (let arrayKey of arrayKeys) {
                    ...
                    if (dependencyValuesByKey[arrayKey].endpointAttr !== null) {
                        endpoint[arrayKey] =
                            dependencyValuesByKey[
                                arrayKey
                            ].endpointAttr.stateValues["x" + varEnding];
                        ...
                        if (
                            ...
                            endpoint[arrayKey] = dependencyValuesByKey[
                                arrayKey
                            ].throughX
                                .subtract(
            ...
            inverseArrayDefinitionByKey({
                ...
                for (let arrayKey in desiredStateVariableValues.endpoint) {
                    if (
                        ...
                        instructions.push({
                            setDependency:
                                dependencyNamesByKey[arrayKey].endpointAttr,
                            desiredValue:
                ...
                if (updateEndpointShadow) {
                    if (arraySize[0] > 1) {
                        ...
                        instructions.push({
                            setDependency: "endpointShadow",
                            desiredValue:
                                desiredStateVariableValues.endpoint[0],
                        });
                    }
                }
