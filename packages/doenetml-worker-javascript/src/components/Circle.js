...
export default class Circle extends Curve {
    ...
    static createAttributesObject() {
        ...
        attributes.addControls = {
            description: "Whether to render interactive control handles on the circle.",
    ...
    static returnStateVariableDefinitions(numerics) {
        ...
        stateVariableDefinitions.hideOffGraphIndicator = {
            description: "Whether to suppress the off-graph indicator when the circle is outside the visible area.",
            public: true,
            forRenderer: true,
            shadowingInstructions: {
                createComponentOfType: "boolean",
        ...
        stateVariableDefinitions.parMax = {
            description: "Maximum value of the curve parameter (always 2π for a circle).",
            public: true,
            shadowingInstructions: {
        ...
        stateVariableDefinitions.parMin = {
            description: "Minimum value of the curve parameter (always 0 for a circle).",
            public: true,
            shadowingInstructions: {
                createComponentOfType: "number",
            },
            ...
            definition: function ({ dependencyValues }) {
                if (dependencyValues.throughAttr !== null) {
                    return {
                        setValue: {
                            numThroughPoints:
                                dependencyValues.throughAttr.stateValues
                                    .numPoints,
                        },
                    };
                } else {
            ...
            async inverseArrayDefinitionByKey({
                ...
                for (let arrayKey in desiredStateVariableValues.throughPoints) {
                    ...
                    if (
                        ...
                        instructions.push({
                            setDependency:
                                dependencyNamesByKey[arrayKey].throughAttr,
                            desiredValue:
                ...
                for (let arrayKey of arrayKeys) {
                    ...
                    if (dependencyValuesByKey[arrayKey].centerAttr !== null) {
                        prescribedCenter[arrayKey] =
                            dependencyValuesByKey[
                                arrayKey
                            ].centerAttr.stateValues["x" + varEnding];
                        ...
                        instructions: [
                            {
                                ...
                                desiredValue:
                                    desiredStateVariableValues.prescribedRadius,
                                childIndex: 0,
                                variableIndex: 0,
                            },
                        ],
        ...
        stateVariableDefinitions.numericalThroughPoints = {
            ...
            inverseDefinition: async function ({
                ...
                if (
                    desiredStateVariableValues.numericalThroughPoints !==
                    undefined
                ) {
        ...
        stateVariableDefinitions.numericalRadiusCalculatedWithCenter = {
            additionalStateVariablesDefined: [
                "numericalCenterCalculatedWithRadius",
            ],
            returnDependencies: () => ({
                numThroughPoints: {
                    dependencyType: "stateVariable",
                ...
                if (dependencyValues.numThroughPoints === 2) {
                    ...
                    return {
                        setValue: {
                            numericalCenterCalculatedWithRadius:
                                numericalCenter,
                            numericalRadiusCalculatedWithCenter:
                                numericalRadius,
                        },
                    };
        ...
        stateVariableDefinitions.numericalRadius = {
            ...
            inverseDefinition: async function ({
                ...
                if (dependencyValues.numThroughPoints < 2) {
                    ...
                    for (
                        let i = 0;
                        i < dependencyValues.numThroughPoints;
                        i++
                    ) {
                    ...
                    for (let arrayKey of arrayKeys) {
                        ...
                        dependenciesByKey[arrayKey] = {
                            numericalPrescribedCenterX: {
                                dependencyType: "stateVariable",
                                variableName:
                                    "numericalPrescribedCenterX" + varEnding,
                            },
                        };
                    }
                } else {
                ...
                for (let arrayKey of arrayKeys) {
                    if (
                        dependencyValuesByKey[arrayKey]
                            .numericalPrescribedCenterX !== undefined
                    ) {
                ...
                if (globalDependencyValues.numericalRadius !== undefined) {
                    ...
                    if (globalDependencyValues.numThroughPoints === 0) {
                        ...
                        let x1 =
                            globalDependencyValues.numericalThroughPoints[0][0];
                        let x2 =
                            globalDependencyValues.numericalThroughPoints[1][0];
                        let y1 =
                            globalDependencyValues.numericalThroughPoints[0][1];
                        let y2 =
                            globalDependencyValues.numericalThroughPoints[1][1];
                        ...
                        if (dist2 === 0) {
                            ...
                            return {
                                setValue: { numericalCenter: [x1, y1 - r] },
                            };
                        }
            ...
            async inverseArrayDefinitionByKey({
                        ...
                        instructions.push({
                            setDependency:
                                dependencyNamesByKey[arrayKey]
                                    .numericalPrescribedCenterX,
                            desiredValue:
                                desiredStateVariableValues.numericalCenter[
                                    arrayKey
                                ],
                        });
                    }
                ...
                if (globalDependencyValues.numThroughPoints === 0) {
                    ...
                    for (let arrayKey in desiredStateVariableValues.numericalCenter) {
                        instructions.push({
                            setDependency:
                                dependencyNamesByKey[arrayKey].essentialCenterX,
                            desiredValue:
                                desiredStateVariableValues.numericalCenter[
                                    arrayKey
                                ],
                    ...
                    for (let key = 0; key < 2; key++) {
                        if (
                            ...
                            workspace.desiredCenter[key] =
                                stateValues.numericalCenter[key];
                        }
                    }
                    ...
                    for (
                        let i = 0;
                        i < globalDependencyValues.numThroughPoints;
                        i++
                    ) {
        ...
        stateVariableDefinitions.diameter = {
            ...
            definition({ dependencyValues }) {
                return {
                    setValue: {
                        diameter: dependencyValues.radius
                            .multiply(2)
                            .simplify(),
                    },
                };
        ...
        stateVariableDefinitions.center = {
            ...
            async inverseArrayDefinitionByKey({
                        ...
                        instructions.push({
                            setDependency:
                                dependencyNamesByKey[arrayKey]
                                    .prescribedCenterX,
                            desiredValue:
                                desiredStateVariableValues.center[arrayKey],
                            arrayKey,
                        });
                    }
                ...
                for (let i = 0; i < 2; i++) {
                    let component =
                        workspace.desiredCenter[i].evaluate_to_constant();
    ...
    async moveCircle({
        ...
        if (numericalPrescribedCenter.length > 0 && numThroughPoints === 1) {
            ...
            if (throughPointUnchanged && !centerUnchanged) {
                ...
                let theta = throughAngles[0];
                let newCenter = [
                    resultingNumericalThroughPoints[0][0] -
                        radius * Math.cos(theta),
                    resultingNumericalThroughPoints[0][1] -
