...
export default class Line extends GraphicalComponent {
    ...
    static returnStateVariableDefinitions() {
        ...
        stateVariableDefinitions.numDimensions = {
            ...
            definition: function ({ dependencyValues, changes }) {
                ...
                if (dependencyValues.equation) {
                    if (
                        changes.equation &&
                        changes.equation.componentIdentitiesChanged
                    ) {
                        return {
                    ...
                    if (dependencyValues.throughAttr) {
                        ...
                        let numDimensions =
                            dependencyValues.parallelToAttr.stateValues
                                .numDimensions;
                        return {
                            setValue: { numDimensions },
                            checkForActualChange: { numDimensions: true },
        ...
        stateVariableDefinitions.equationIdentity = {
            ...
            definition: function ({ dependencyValues }) {
                ...
                if (dependencyValues.equation !== null) {
                    return {
                        setValue: {
                            equationIdentity: dependencyValues.equation,
                        },
                    };
                } else {
                        ...
                        if (
                            ...
                            if (stateValues.numPointsPrescribed === 0) {
                                ...
                                dependenciesByKey[arrayKey].essentialPoint = {
                                    dependencyType: "stateVariable",
                                    variableName:
                                        "essentialPointX2_" + (Number(dim) + 1),
                                };
                            }
                        } else {
                    ...
                    for (let arrayKey of arrayKeys) {
                        ...
                        if (
                            ...
                            if (
                                ...
                                let point1;
                                if (
                                    globalDependencyValues.numPointsPrescribed ===
                                    1
                                ) {
                                    point1 =
                                        dependencyValuesByKey[arrayKey].through
                                            .stateValues[
                                            "pointX1_" + (Number(dim) + 1)
                                        ];
                                } else {
            ...
            async inverseArrayDefinitionByKey({
                ...
                if ("coeff0" in globalDependencyValues) {
                    ...
                    if (
                        ...
                        if (
                            prodDiff <
                            Math.abs(coeffvar1 * sVCoeffVar2) * 1e-12
                        ) {
                    ...
                    if (
                        ...
                        for (let dim = 0; dim < arraySize[1]; dim++) {
                            let desiredP1val =
                                desiredStateVariableValues.points["1," + dim];

                            if (desiredP1val) {
                                if (desiredP1val instanceof me.class) {
                                    desiredP1val =
                                        desiredP1val.evaluate_to_constant();
                                }

                                workspace.desiredPoint1[dim] = desiredP1val;
                            } else if (
                                workspace.desiredPoint1[dim] === undefined
                            ) {
                                workspace.desiredPoint1[dim] = (
                                    await stateValues.points
                                )[1][dim].evaluate_to_constant();
                            }
                        }
                    }
        ...
        stateVariableDefinitions.equation = {
            ...
            definition: function ({ dependencyValues }) {
                ...
                if (dependencyValues.equation) {
                    ...
                    let result = calculateCoeffsFromEquation({
                        equation,
                        variables,
                    });
                        ...
                        instructions: [
                            {
                                ...
                                desiredValue:
                                    desiredStateVariableValues.equation,
                                variableIndex: 0,
                            },
                        ],
                    };
        ...
        stateVariableDefinitions.numericalCoeff0 = {
            ...
            definition: function ({ dependencyValues }) {
                let numericalCoeff0 =
                    dependencyValues.coeff0.evaluate_to_constant();
                ...
                return {
                    setValue: {
                        nearestPoint: function ({
                            ...
                            let result = {};
                            result.x1 =
                                ((b * (b * x1Effective - a * x2Effective) -
                                    a * c) *
                                    xscale) /
                                denom;
                            result.x2 =
                                ((a * (-b * x1Effective + a * x2Effective) -
                                    b * c) *
                                    yscale) /
                                denom;
