...
export class Derivative extends FunctionBaseOperator {
    ...
    static returnStateVariableDefinitions(numerics) {
        ...
        stateVariableDefinitions.operatorComposesWithOriginal = {
            returnDependencies: () => ({}),
            definition: () => ({
                setValue: { operatorComposesWithOriginal: false },
            }),
        };
            ...
            arrayDefinitionByKey({
                ...
                if (
                    ...
                    let variablesFromAttribute =
                        globalDependencyValues.derivVariablesAttr?.stateValues
                            .variables;
                    if (!variablesFromAttribute) {
                        variablesFromAttribute = [
                            globalDependencyValues.derivVariableAttr.stateValues
                                .value,
                        ];
                    }
            ...
            definition({ dependencyValues }) {
                if (dependencyValues.derivVariablesAttr !== null) {
                    return {
                        setValue: {
                            numDerivatives:
                                dependencyValues.derivVariablesAttr.stateValues
                                    .numComponents,
                        },
                    };
                } else {
        ...
        stateVariableDefinitions.derivVariables = {
            description: "Variables with respect to which derivatives are taken.",
            isArray: true,
            public: true,
            shadowingInstructions: {
                createComponentOfType: "_variableName",
            ...
            arrayDefinitionByKey({ globalDependencyValues }) {
                if (globalDependencyValues.derivVariablesAttr !== null) {
                    return {
                        setValue: {
                            derivVariables:
                                globalDependencyValues.derivVariablesAttr
                    ...
                    return {
                        setValue: {
                            derivVariables: [
                                globalDependencyValues.derivVariableAttr
                                    .stateValues.value,
                            ],
                        },
                    };
                    ...
                    return {
                        setValue: {
                            derivVariables: {
                                0: globalDependencyValues.variable1,
                            },
                        },
                    };
                }
        ...
        stateVariableDefinitions.numericalFunctionOperator = {
            ...
            definition: function ({ dependencyValues }) {
                ...
                return {
                    setValue: {
                        numericalFunctionOperator:
                            derivativeNumericalFunctionOperator,
                        returnNumericalDerivatives:
                            augmentedReturnNumericalDerivatives,
                    },
                };
            },
        };
