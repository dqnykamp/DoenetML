...
export default class SolveEquations extends InlineComponent {
    ...
    static createAttributesObject() {
        ...
        attributes.numDiscretizationPoints = {
            description: "Number of points used when searching for solutions numerically.",
    ...
    static returnStateVariableDefinitions(numerics) {
            ...
            definition({ dependencyValues }) {
                ...
                for (let ind = 1; ind < testPoints.length; ind++) {
                    ...
                    if (thisF === 0) {
                        ...
                        if (
                            !addedExactZero &&
                            !numericalSolutions.includes(thisX)
                        ) {
                            numericalSolutions.push(thisX);
                        }
        ...
        stateVariableDefinitions.numSolutions = {
            ...
            definition({ dependencyValues }) {
                return {
                    setValue: {
                        numSolutions: dependencyValues.allSolutions.length,
                    },
                };
            },
        };
        ...
        stateVariableDefinitions.solutions = {
            ...
            arrayDefinitionByKey({ globalDependencyValues }) {
                ...
                for (
                    let key = 0;
                    key < globalDependencyValues.__array_size[0];
                    key++
                ) {
