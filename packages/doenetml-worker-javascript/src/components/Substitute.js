...
export default class Substitute extends CompositeComponent {
    ...
    static createAttributesObject() {
        ...
        attributes.matchWholeWord = {
            description: "Whether matching is restricted to whole words (text mode).",
        ...
        attributes.preserveCase = {
            description: "Whether the case of the original is preserved when substituting.",
            createComponentOfType: "boolean",
        ...
        stateVariableDefinitions.value = {
            ...
            definition({ dependencyValues }) {
                ...
                if (
                    ...
                    return {
                        setValue: { value: dependencyValues.originalValue },
                    };
                }
                ...
                if (dependencyValues.type === "text") {
                    ...
                    // math
                    let value =
                        dependencyValues.originalValue.subscripts_to_strings();
            ...
            inverseDefinition({
                ...
                if (dependencyValues.type === "text") {
                    ...
                    let variablesOfOrig =
                        dependencyValues.originalValue.variables(true);
