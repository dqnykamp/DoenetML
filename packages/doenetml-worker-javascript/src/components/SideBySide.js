    ...
    static returnStateVariableDefinitions() {
        ...
        stateVariableDefinitions.numPanels = {
            ...
            definition({ dependencyValues }) {
                return {
                    setValue: {
                        numPanels: dependencyValues.blockChildren.length,
                    },
                    ...
                    if (ind < nWidthsSpecifiedFromAttrs) {
                        ...
                        if (dependencyValues.parentWidths) {
                            if (dependencyValues.essentialWidth[ind] === null) {
                                allWidthsSpecified[ind] =
                                    dependencyValues.parentWidths[ind];
                            } else {
                                allWidthsSpecified[ind] =
                                    dependencyValues.essentialWidth[ind];
                            }
                            thisAbsolute =
                                dependencyValues.parentWidthsAbsolute;
                        } else {
                            allWidthsSpecified[ind] =
                                dependencyValues.essentialWidth[ind];
                        }
            ...
            definition({ dependencyValues }) {
                ...
                if (dependencyValues.marginsAttr === null) {
                    if (dependencyValues.parentMargins) {
                        marginsAbsolute =
                            dependencyValues.parentMarginsAbsolute;
                        for (let ind = 0; ind < 2; ind++) {
                            if (
                                dependencyValues.essentialMargins[ind] === null
                            ) {
                                allMarginsSpecified[ind] =
                                    dependencyValues.parentMargins[ind];
                            } else {
                                allMarginsSpecified[ind] =
        ...
        stateVariableDefinitions.absoluteMeasurements = {
            description: "Whether children's widths are interpreted in absolute units.",
            public: true,
            ...
            definition({ dependencyValues }) {
                ...
                if (!dependencyValues.absoluteMeasurements) {
                    if (totalWidthSpecified + totalMarginSpecified >= 100) {
                        ...
                        for (
                            let ind = 0;
                            ind < dependencyValues.numPanels;
                            ind++
                        ) {
        ...
        stateVariableDefinitions.widths = {
            ...
            arrayDefinitionByKey({ globalDependencyValues, arrayKeys }) {
                ...
                for (let arrayKey of arrayKeys) {
                    widths[arrayKey] =
                        globalDependencyValues.allWidths[arrayKey];
                }
            ...
            inverseArrayDefinitionByKey({
                ...
                if (globalDependencyValues.widthsAttr !== null) {
                    nWidthsSpecifiedFromAttrs =
                        globalDependencyValues.widthsAttr.stateValues
                            .numComponents;
                    ...
                    if (arrayIndex < nWidthsSpecifiedFromAttrs) {
                        if (usingSingleWidth) {
                            ...
                            instructions.push({
                                ...
                                desiredValue: {
                                    size: desiredStateVariableValues.widths[
                                        arrayKey
                                    ],
                                    isAbsolute:
                                        globalDependencyValues.absoluteMeasurements,
                                },
                                variableIndex: 0,
                            });
                        } else {
                            instructions.push({
                                setDependency:
                                    dependencyNamesByKey[arrayKey].widthsAttr,
                                desiredValue: {
                                    size: desiredStateVariableValues.widths[
                                        arrayKey
                                    ],
                        ...
                        instructions.push({
                            setDependency:
                                dependencyNamesByKey[arrayKey].essentialWidth,
                            desiredValue:
                                desiredStateVariableValues.widths[arrayKey],
                        });
                    }
                }
        ...
        stateVariableDefinitions.margins = {
            ...
            arrayDefinitionByKey({ globalDependencyValues, arrayKeys }) {
                ...
                for (let arrayKey of arrayKeys) {
                    margins[arrayKey] =
                        globalDependencyValues.allMargins[arrayKey];
                }
            ...
            inverseArrayDefinitionByKey({
                ...
                if (globalDependencyValues.marginsAttr === null) {
                    for (let arrayKey in desiredStateVariableValues.margins) {
                        instructions.push({
                            setDependency:
                                dependencyNamesByKey[arrayKey].essentialMargin,
                            desiredValue:
                    ...
                    for (let arrayKey in desiredStateVariableValues.margins) {
                        if (symmetricMargins) {
                            ...
                            instructions.push({
                                setDependency: "marginsAttr",
                                desiredValue: {
                                    size: desiredStateVariableValues.margins[
                                        arrayKey
                                    ],
                                    isAbsolute:
                                        globalDependencyValues.absoluteMeasurements,
        ...
        stateVariableDefinitions.valigns = {
            ...
            arrayDefinitionByKey({
                ...
                if (globalDependencyValues.valignsAttr !== null) {
                    nValignsSpecifiedFromAttrs =
                        globalDependencyValues.valignsAttr.stateValues
                            .numComponents;
            ...
            inverseArrayDefinitionByKey({
                ...
                for (let arrayKey in desiredStateVariableValues.valigns) {
                    let desiredValue =
                        desiredStateVariableValues.valigns[
                            arrayKey
                        ].toLowerCase();
                    ...
                    if (arrayIndex < nValignsSpecifiedFromAttrs) {
                        if (usingSingleValign) {
                            ...
                            instructions.push({
                                setDependency:
                                    dependencyNamesByKey[arrayKey].valignsAttr,
                                desiredValue,
                                variableIndex: 0,
                            });
                        }
                        ...
                        instructions.push({
                            setDependency:
                                dependencyNamesByKey[arrayKey].essentialValign,
                            desiredValue,
                        });
                    }
                }
    ...
    static returnStateVariableDefinitions() {
            ...
            arrayDefinitionByKey({
                ...
                for (let arrayKey of arrayKeys) {
                    ...
                    if (arrayIndex < nWidthsSpecifiedFromAttrs) {
                        if (usingSingleWidth) {
                            if (
                                globalDependencyValues.widthAttr.stateValues
                                    .componentSize
                            ) {
                            ...
                            let widthComponentSize =
                                dependencyValuesByKey[arrayKey].widthsAttr
                                    .stateValues[`componentSize${varEnding}`];

                            if (widthComponentSize) {
                                specifiedWidths[arrayKey] =
                                    widthComponentSize.size;
                                widthsAbsoluteArray[arrayKey] =
                                    widthComponentSize.isAbsolute;
                            }
                        }
                    } else {
                ...
                let result = {
                    setValue: { widthsAbsoluteArray, specifiedWidths },
                };
                    ...
                    if (arrayIndex < nWidthsSpecified) {
                        if (usingSingleWidth) {
                            ...
                            instructions.push({
                                setDependency: "widthAttr",
                                desiredValue: {
                                    size: desiredStateVariableValues
                                        .specifiedWidths[arrayKey],
                        ...
                        instructions.push({
                            ...
                            value: {
                                [arrayKey]:
                                    desiredStateVariableValues.specifiedWidths[
                                        arrayKey
                                    ],
                            },
                        });
        ...
        stateVariableDefinitions.widthsAbsolute = {
            ...
            definition({ dependencyValues }) {
                ...
                for (let ind in dependencyValues.widthsAbsoluteArray) {
                    let thisAbsolute =
                        dependencyValues.widthsAbsoluteArray[ind];
        ...
        stateVariableDefinitions.specifiedMargins = {
            ...
            arrayDefinitionByKey({
                ...
                let result = {
                    setValue: { marginsAbsoluteArray, specifiedMargins },
                };
                            ...
                            instructions.push({
                                ...
                                desiredValue: {
                                    size: desiredStateVariableValues
                                        .specifiedMargins[1],
                                    isAbsolute:
                                        await stateValues.marginsAbsolute,
                                },
                                variableIndex: 1,
                            });
                        }
        ...
        stateVariableDefinitions.marginsAbsolute = {
            ...
            definition({ dependencyValues }) {
                ...
                for (let ind in dependencyValues.marginsAbsoluteArray) {
                    let thisAbsolute =
                        dependencyValues.marginsAbsoluteArray[ind];
                    if (thisAbsolute !== null) {
                        thisAbsolute = Boolean(thisAbsolute);
                            ...
                            let newMargin =
                                (100 -
                                    (totalWidthSpecified +
                                        totalMarginSpecified)) /
                                (nMarginsUndefined *
                                    dependencyValues.maxNPanelsPerRow);
                            for (let ind = 0; ind < 2; ind++) {
                                if (allMargins[ind] === null) {
                                    allMargins[ind] = newMargin;
                                }
        ...
        stateVariableDefinitions.widths = {
            ...
            inverseArrayDefinitionByKey({
                ...
                for (let arrayKey in desiredStateVariableValues.widths) {
                    instructions.push({
                        setDependency:
                            dependencyNamesByKey[arrayKey].specifiedWidth,
                        desiredValue:
                            desiredStateVariableValues.widths[arrayKey],
                        variableIndex: 0,
                    });
        ...
        stateVariableDefinitions.margins = {
            ...
            inverseArrayDefinitionByKey({
                ...
                for (let arrayKey in desiredStateVariableValues.margins) {
                    instructions.push({
                        setDependency:
                            dependencyNamesByKey[arrayKey].specifiedMargin,
                        desiredValue:
                            desiredStateVariableValues.margins[arrayKey],
                        variableIndex: 0,
                    });
