...
export default class DataFrame extends BaseComponent {
    ...
    static createAttributesObject() {
        ...
        attributes.hasHeader = {
            description: "Whether the first row of data contains column headers.",
        ...
        stateVariableDefinitions.dataFrame = {
            ...
            additionalStateVariablesDefined: [
                {
                    ...
                    public: true,
            description: "The full data frame (rows × columns of typed values).",
            ...
            definition: function ({ dependencyValues, componentIdx }) {
                ...
                for (let colInd = 0; colInd < numColumns; colInd++) {
                    let prescribedType =
                        dependencyValues.columnTypesPrelim[
                            colInd
                        ]?.toLowerCase();
        ...
        stateVariableDefinitions.means = {
            ...
            arrayDefinitionByKey({ globalDependencyValues, arrayKeys }) {
                ...
                for (let arrayKey of arrayKeys) {
                    ...
                    let numValues = 0;
                    if (
                        globalDependencyValues.columnTypes[arrayKey] ===
                        "number"
                    ) {
                        for (
                            let rowInd = 0;
                            ...
                            let theValue =
                                globalDependencyValues.dataFrame.data[rowInd][
                                    arrayKey
                                ];
                            if (theValue !== null) {
                                theMean += theValue;
